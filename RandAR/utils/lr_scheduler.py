...
def get_cosine_schedule_with_warmup(
    ...
    def lr_lambda(current_step):
        ...
        ratio = 0.5 * (1.0 + math.cos(math.pi * float(num_cycles) * 2.0 * progress))
        return min_lr_ratio * (1 - ratio) + 1.0 * ratio
...
def get_scheduler(
    ...
    Args:
        ...
        last_epoch (`int`, *optional*, defaults to -1):
            The index of the last epoch when resuming training.
        min_lr_ratio (`float`, *optional*, defaults to 0.05):
            The minimum learning rate ratio to use.
    """
